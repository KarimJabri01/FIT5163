...
int main() {
    ...
    // const std::string &in_card_number, const int &in_cvv, const std::string &in_exp_date, const std::string & in_currency, const int &in_account_nb) 
    //     : card_number(in_card_number), cvv(in_cvv), exp_date(in_exp_date), currency(in_currency), account_nb(in_account_nb)
    // CardNumber,AccountNumber,CVV,ExpDate,Currency,PIN,Password,Balance
